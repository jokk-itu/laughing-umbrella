        ...
        <ul class="uk-navbar-nav">
            ...
            <li class="uk-navbar-item">
                ...
                { :then authenticationResult }
                    <span on:click={ async () => await _authService.logout() } uk-icon="sign-out">Logout</span>
                { :catch error }
                    <span on:click={ async () => await _authService.login() } uk-icon="sign-in">Login</span>
                { /await }
            </li>
            <li class="uk-navbar-item">
                <div class="uk-inline">
                    <span uk-icon="user">Account</span>
